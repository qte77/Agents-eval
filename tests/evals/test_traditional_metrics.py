...
from app.evals.traditional_metrics import TraditionalMetricsEngine, evaluate_single_traditional
...
class TestTraditionalMetricsEngine:
    ...
    def test_semantic_similarity_with_bertscore(self, mock_bertscore, engine, sample_texts):
