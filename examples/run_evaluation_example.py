...
from app.evals.trace_processors import TraceCollector, get_trace_collector
from app.data_models.evaluation_models import CompositeEvaluationResult, GraphTraceData
...
async def run_evaluation_example():
    ...
    try:
        ...
        print(f"API Cost: ${tier2_result.api_cost:.4f}" if tier2_result.api_cost else "API Cost: $0.0000")
