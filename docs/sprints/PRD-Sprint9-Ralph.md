...
|---|---|---|
| F1, F2, F3, F5 | `peerread_tools.py` | F1→F2→F3→F5 (sequential) |
| F1, F4, F5 | `agent_system.py` | F1→F4→F5 (sequential) |
| F6, F8 | `traditional_metrics.py` | F6→F8 (sequential) |
...
```text
Wave 1 (independent): STORY-001 (F1 dead code), STORY-007 (F7 typing), STORY-009 (F9 test quality)
...
Wave 4 (after Wave 3): STORY-005 (F5 security bundle)
```
