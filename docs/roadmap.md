...
| **Sprint 10** | In Progress | CC evaluation pipeline parity (review text wiring, engine_type, GUI CC execution), graph visualization polish (mode-specific messages, Tier 3 label), reference reviews from PeerRead, process group kill, inspect.getsource removal | [PRD Sprint 10](sprints/PRD-Sprint10-Ralph.md) |
