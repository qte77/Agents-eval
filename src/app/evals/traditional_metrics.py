...
class TraditionalMetricsEngine:
    ...
    def assess_task_success(self, similarity_scores: SimilarityScores, 
    ...
    def compute_all_similarities(self, agent_output: str, reference_text: str) -> SimilarityScores:
    ...
    def find_best_match(self, agent_output: str, reference_texts: List[str]) -> SimilarityScores:
        ...
        all_scores = [
            self.compute_all_similarities(agent_output, ref) 
    ...
    def evaluate_traditional_metrics(self, 
        ...
        weights = config.get('tier1_weights', {
            'semantic': 0.4,
            'cosine': 0.3,
            'jaccard': 0.2,
            'time_taken': 0.1
...
def evaluate_single_traditional(agent_output: str,
                               reference_texts: List[str],
                               config: Optional[Dict[str, Any]] = None) -> Tier1Result:
