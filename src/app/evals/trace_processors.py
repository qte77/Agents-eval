...
class TraceCollector:
    ...
    def log_tool_call(self, agent_id: str, tool_name: str, 
                     success: bool, duration: float, context: str = "") -> None:
    ...
    def log_coordination_event(self, manager_agent: str, event_type: str, 
                             target_agents: List[str], data: Dict[str, Any]) -> None:
    ...
    def end_execution(self) -> Optional[ProcessedTrace]:
    ...
    def _store_trace(self, trace: ProcessedTrace) -> None:
        ...
        try:
            ...
            if self.performance_logging:
                logger.info(f"Stored trace {trace.execution_id}: "
    ...
    def load_trace(self, execution_id: str) -> Optional[GraphTraceData]:
...
class TraceProcessor:
    ...
    def process_for_graph_analysis(self, execution_id: str) -> Optional[Dict[str, Any]]:
