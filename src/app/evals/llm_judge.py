...
Provide scores and brief explanation."""
    ...
    async def evaluate_llm_judge(self, paper: str, review: str, 
        ...
        try:
            ...
            weights = self.config.get('tier2_llm_judge', {}).get('weights', {
    ...
    def _extract_planning_decisions(self, execution_trace: Dict[str, Any]) -> str:
        ...
        try:
            ...
            if decisions:
                decision_types = [d.get('type', 'unknown') for d in decisions[:5]]  # First 5
    ...
    def _fallback_constructiveness_check(self, review: str) -> float:
        ...
        constructive_phrases = [
            ...
            'however', 'although', 'while', 'despite', 'potential'
        ]
    ...
    def _fallback_planning_check(self, execution_trace: Dict[str, Any]) -> float:
        ...
        try:
            ...
            if total_activity <= 2:
                ...
                activity_score = max(0.5, 1.0 - (total_activity - 10) * 0.05)  # Diminishing returns
...
async def evaluate_single_llm_judge(paper: str, 
                                   review: str,
                                   execution_trace: Optional[Dict[str, Any]] = None,
                                   config: Optional[Dict[str, Any]] = None) -> Tier2Result:
