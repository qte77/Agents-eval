...
class GraphTraceData(BaseModel):
    ...
    agent_interactions: List[Dict[str, Any]] = Field(
        description="Agent-to-agent communications",
        default_factory=list
    )
    tool_calls: List[Dict[str, Any]] = Field(
        description="Tool usage sequence",
        default_factory=list
    )
    ...
    coordination_events: List[Dict[str, Any]] = Field(
        description="Manager delegation patterns",
        default_factory=list
    )
...
class EvaluationConfig(BaseModel):
    ...
    bertscore_model: str = Field(
        ...
        description="BERTScore model name"
    )
...
class EvaluationRequest(BaseModel):
    ...
    execution_trace: Optional[GraphTraceData] = None
