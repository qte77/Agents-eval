...
for _flag, _help in [
    ...
    ("--judge-provider", "Tier 2 LLM judge provider (default: auto, inherits chat provider)"),
    ("--judge-model", "Override Tier 2 judge LLM model (default: inherits chat model when auto)"),
