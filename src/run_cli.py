...
_COMMANDS = {
    ...
    "--paper-id": "Specify paper ID for PeerRead review generation (supports arxiv IDs like '1105.1072')",
    "--judge-provider": "Override Tier 2 judge LLM provider (default: auto, inherits chat provider)",
