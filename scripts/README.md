...
```bash
./scripts/collect-cc-solo.sh --name <session-name> --output-dir <path>
```
...
```bash
./scripts/collect-cc-solo.sh --name my-session --output-dir ./artifacts/solo-run
```
...
```bash
./scripts/collect-cc-teams.sh --name <team-name> --output-dir <path> \
...
```bash
./scripts/collect-cc-teams.sh --name review-team --output-dir ./artifacts/teams-run
```
